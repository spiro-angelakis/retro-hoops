...
@onready var ball_down_button = $VBoxContainer/BallType/ButtonContainer/VBoxContainer/ButtonsHbox/BallDownButton
@onready var ball_up_button = $VBoxContainer/BallType/ButtonContainer/VBoxContainer/ButtonsHbox/BallUpButton

@onready var hoop_down_button = $VBoxContainer/HoopType/ButtonContainer/VBoxContainer/ButtonsHbox/HoopDownButton
@onready var hoop_up_button = $VBoxContainer/HoopType/ButtonContainer/VBoxContainer/ButtonsHbox/HoopUpButton

@onready var cage_down_button = $VBoxContainer/CageType/ButtonContainer/VBoxContainer/ButtonsHbox/CageDownButton
@onready var cage_up_button = $VBoxContainer/CageType/ButtonContainer/VBoxContainer/ButtonsHbox/CageUpButton


@onready var room_down_button = $VBoxContainer/RoomType/ButtonContainer/VBoxContainer/ButtonsHbox/RoomDownButton
@onready var room_up_button = $VBoxContainer/RoomType/ButtonContainer/VBoxContainer/ButtonsHbox/RoomUpButton



@onready var buy_ball_skin_button = $VBoxContainer/BallType/ButtonContainer/VBoxContainer/BuyContainer/BuyBallSkinButton
@onready var buy_ball_skin_text = $VBoxContainer/BallType/ButtonContainer/VBoxContainer/BuyContainer/BuyBallSkinText
@onready var buy_hoop_skin_button = $VBoxContainer/HoopType/ButtonContainer/VBoxContainer/BuyContainer/BuyHoopSkinButton
@onready var buy_hoop_skin_text = $VBoxContainer/HoopType/ButtonContainer/VBoxContainer/BuyContainer/BuyHoopSkinText
@onready var buy_cage_skin_button = $VBoxContainer/CageType/ButtonContainer/VBoxContainer/BuyContainer/BuyCageSkinButton
@onready var buy_cage_skin_text = $VBoxContainer/CageType/ButtonContainer/VBoxContainer/BuyContainer/BuyCageSkinText
@onready var buy_room_skin_button = $VBoxContainer/RoomType/ButtonContainer/VBoxContainer/BuyContainer/BuyRoomSkinButton
@onready var buy_room_skin_text = $VBoxContainer/RoomType/ButtonContainer/VBoxContainer/BuyContainer/BuyRoomSkinText
@onready var buy_aim_level_button = $VBoxContainer/AimSkill/ButtonContainer/VBoxContainer/BuyContainer/BuyAimLevelButton
@onready var buy_aim_level_text = $VBoxContainer/AimSkill/ButtonContainer/VBoxContainer/BuyContainer/BuyAimLevelText
...
func _physics_process(delta):
	if visible:
		check_texts()
		validate_buy_buttons()
		validate_arrow_buttons()
...
func validate_arrow_buttons():
	
	
	if GameBrain.ball_index == GameBrain.game_data["unlocked balls"]:
		ball_up_button.visible = false
	elif GameBrain.ball_index < GameBrain.game_data["unlocked balls"]:
		ball_up_button.visible = true
	
	if GameBrain.ball_index == 1:
		ball_down_button.visible = false
	elif GameBrain.ball_index > 1:
		ball_down_button.visible = true
	
	
	if GameBrain.hoop_index == GameBrain.game_data["unlocked hoops"]:
		hoop_up_button.visible = false
	elif GameBrain.hoop_index < GameBrain.game_data["unlocked hoops"]:
		hoop_up_button.visible = true
	
	if GameBrain.hoop_index == 1:
		hoop_down_button.visible = false
	elif GameBrain.hoop_index > 1:
		hoop_down_button.visible = true
	
	if GameBrain.cage_index == GameBrain.game_data["unlocked cages"]:
		cage_up_button.visible = false
	elif GameBrain.cage_index < GameBrain.game_data["unlocked cages"]:
		cage_up_button.visible = true
	
	if GameBrain.cage_index == 1:
		cage_down_button.visible = false
	elif GameBrain.cage_index > 1:
		cage_down_button.visible = true
	
	
	if GameBrain.room_index == GameBrain.game_data["unlocked rooms"]:
		room_down_button.visible = false
	elif GameBrain.room_index < GameBrain.game_data["unlocked rooms"]:
		room_down_button.visible = true
	
	if GameBrain.room_index == 1:
		room_down_button.visible = false
	elif GameBrain.room_index > 1:
		room_down_button.visible = true
	


func validate_buy_buttons():
	
	
	if GameBrain.game_data["unlocked balls"] >= 8:
		buy_ball_skin_button.visible = false
		buy_ball_skin_text.visible = false
	
	if GameBrain.game_data["unlocked hoops"] >= 5:
		buy_hoop_skin_button.visible = false
		buy_hoop_skin_text.visible = false
	
	if GameBrain.game_data["unlocked cages"] >= 9:
		buy_cage_skin_button.visible = false
		buy_cage_skin_text.visible = false
	
	if GameBrain.game_data["unlocked rooms"] >= 6:
		buy_room_skin_button.visible = false
		buy_room_skin_text.visible = false
	
	if GameBrain.game_data["aim skill"] <= 0.1:
		buy_aim_level_button.visible = false
		buy_aim_level_text.visible = false
...
func check_hoopname():
	if GameBrain.hoop_index == 1 and hoop_name_index != 1:
		...
		hoop_name_index = 2
		hoopnametext.bbcode_text = str("[center] Pinky [/center]")
